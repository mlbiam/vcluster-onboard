...
helm install kubernetes-dashboard kubernetes-dashboard/kubernetes-dashboard   --set settings.clusterName=$VCLUSTER_LABEL --set settings.itemsPerPage=15 -f /usr/local/openunison/kubernetes-dashboard-values.yaml -n kubernetes-dashboard
